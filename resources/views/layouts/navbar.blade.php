                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @if (auth()->user()->role_id === 1)
                            <li>
                                <a href="{{ route('profile.index') }}" class="gap-2 d-flex align-items-center justify-content-center text-dark text-decoration-none fw-bold">
                                    <i class="fa fa-user pe-1" aria-hidden="true"></i> Profil Saya
                                </a>
                            </li>
                        @elseif (auth()->user()->role_id === 2)
                            <li class="px-3">
                                <a href="#" class="gap-2 d-flex align-items-center justify-content-center text-dark text-decoration-none fw-bold">
