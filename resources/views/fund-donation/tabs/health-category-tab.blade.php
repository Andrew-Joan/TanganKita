    ...
    @foreach ($healthDonations as $healthDonation)
        ...
        <div class="col-md-3 shadow rounded-4 py-2 border">
            <div class="campaign-card">
                <div class="p-3">
                    @if ($healthDonation->image)
                        <img class="object-fit-cover w-100 rounded-3" src="data:image/png;base64,{{ $healthDonation->image }}" alt="Campaign Image" style="width: 300px; height:200px;">
                    @else
                    ...
                    <h5><a href="{{ route('fund-donation.show', $healthDonation->id) }}" class="text-dark">{{ $healthDonation->title }}</a></h5>
                    ...
                    <div class="d-flex justify-content-center align-items-center mt-2">
                        @if ($healthDonation->user_id !== auth()->id())
