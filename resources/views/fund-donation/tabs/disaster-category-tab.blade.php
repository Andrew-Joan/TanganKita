    ...
    @foreach ($disasterDonations as $disasterDonation)
        ...
        <div class="col-md-3 shadow rounded-4 py-2 border">
            <div class="campaign-card">
                <div class="p-3">
                    @if ($disasterDonation->image != null)
                        <img class="object-fit-cover w-100 rounded-3" src="{{ asset('storage/' . $disasterDonation->image) }}" alt="Campaign Image" style="width: 300px; height:200px;">
                    @else
